...
namespace TestProject1
{
    public class Tests
    {
        ...
        {
            string cs = @"server=supriyaadmin.database.windows.net;User Id=supadmin;Password=admi@12345678;Database=JoesPizzaDB2;Trusted_Connection=False;Encrypt=True;";
        ...
        {
            SqlConnection conn = new SqlConnection("server=supriyaadmin.database.windows.net;User Id=supadmin;Password=admi@12345678;Database=JoesPizzaDB;Trusted_Connection=False;Encrypt=True;;Database=JoesPizzaDB;Integrated Security=true;");
            conn.Open();
